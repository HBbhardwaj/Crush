...
class CreateCrush extends StatefulWidget {
  const CreateCrush({ Key? key, }) : super(key: key);

  @override
  State<CreateCrush> createState() => _CreateCrushState();
}

class _CreateCrushState extends State<CreateCrush> {
...
final imagePicker = ImagePicker();
 ...
 void _loadUserID() async {
  ...
  Future<AddCrush> addyourCrush() async {
    var request = http.MultipartRequest('POST', Uri.parse(Apis.addCrush));
...
request.files.add(await http.MultipartFile.fromPath('crush_image', imagelink));
